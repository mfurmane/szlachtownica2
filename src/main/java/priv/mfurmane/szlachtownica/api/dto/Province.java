...
public class Province {
    ...
    private List<SubProvince> subProvinces = new ArrayList<>();
    ...
    public Province setArea(Geometry area) {
        this.area = area;
        return this;
    }

    public List<SubProvince> getSubProvinces() {
        return subProvinces;
    }

    public Province setSubProvinces(List<SubProvince> subProvinces) {
