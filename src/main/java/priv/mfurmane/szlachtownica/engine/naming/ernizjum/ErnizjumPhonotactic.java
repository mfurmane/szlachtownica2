package priv.mfurmane.szlachtownica.engine.naming.ernizjum;
...
public class ErnizjumPhonotactic implements Phonotactic {

    private final Morphology morphology = new ErnizjumMorphology();
