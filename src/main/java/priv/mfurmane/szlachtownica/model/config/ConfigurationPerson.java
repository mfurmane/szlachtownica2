...
// biology & society
    ...
    public static Builder builder() {
        return new ConfigurationPerson.Builder();
    }

    public ConfigurationPerson(){}

    private ConfigurationPerson(Builder builder){
    ...
    public void mergeFrom(ConfigurationPerson other) {
    ...
    public static class Builder {
        ...
        public ConfigurationPerson build() {
            return new ConfigurationPerson(this);
        }
    }
