...
public class VillageNameGenerator {
    ...
    private static List<WordCore> areas = List.of(
            //NEUTRAL
            new WordCore("wzgórz", WordCategory.TERRAIN, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createE("wzgórz"), List.of(AdjectiveForms.createOwy("wzgórz")), "Wzgórzyca;Wzgórzanka;Zawzgórze"),
            ...
            new WordCore("grodzisk", WordCategory.STRUCTURE, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createO("grodzisk"), List.of(AdjectiveForms.createOwy("grodzisk")), "").places(Landmark.STRONGHOLD),
            new WordCore("błot", WordCategory.TERRAIN, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createO("błot"), List.of(AdjectiveForms.createYI("błotn"), AdjectiveForms.createSty("błotni")), "Zabłocie;Błotnica;Podbłocie;Błocianka;Błotówka"),
            new WordCore("pol", WordCategory.TERRAIN, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createE("pol"), List.of(AdjectiveForms.createYI("poln")), "Zapole;Podpole;Zapolice;Polówek"),
            ...
            new WordCore("słońc", WordCategory.TERRAIN, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createE("słońc"), List.of(AdjectiveForms.createYI("słoneczn")), "Słoneczno;Słonecznica;Słońcówka"),
            new WordCore("zarośl", WordCategory.PLANT, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createE("zarośl"), List.of(new AdjectiveForms("zarośnięty", "zarośnięta", "zarośnięte", "zarośnięci", "zarośnięte"), new AdjectiveForms("zarosły", "zarosła", "zarosłe", "zarośli", "zarosłe")), "Zarośle;Zaroślanka;Zaroślówka").requires(EnvFeature.FOREST),
            new WordCore("łon", WordCategory.PLANT, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createO("łon"), List.of(AdjectiveForms.createOwy("łon")), "Łoniaki;Łonianka;Łonówka"),
            //FEMININE
            ...
            new WordCore("sarn", WordCategory.ANIMAL, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("sarn"), List.of(AdjectiveForms.createNi("sar")), "Sarnów;Sarnowa;Sarnówka;Sarnówek;Sarnina;Sarnianka"),
            ...
            new WordCore("krow", WordCategory.ANIMAL, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("krow"), List.of(AdjectiveForms.createI("krow")), "Krowica;Krowianki;Krowizna;Krowinek;Krowiak;Krowiniec"),
            new WordCore("koz", WordCategory.ANIMAL, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("koz"), List.of(AdjectiveForms.createI("koz")), "Kozy;Koźle;Kozice;Koźlanka;Kozówka;Kozianka"),
            new WordCore("owc", WordCategory.ANIMAL, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAe("owc"), List.of(AdjectiveForms.createCzy("ow")), "Owczary;Owczarnia;Owczanka;Owcówka"),
            new WordCore("kaczk", WordCategory.ANIMAL, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAi("kaczk"), List.of(AdjectiveForms.createYY("kacz")), "Kaczory;Kaczanica;Kaczówek;Kaczyniec").requires(EnvFeature.WATER),
            ...
            new WordCore("ryb", WordCategory.ANIMAL, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("ryb"), List.of(AdjectiveForms.createI("ryb")), "Rybno;Rybnica;Zarybie;Międzyrybie;Rybianka;Rybówek").requires(EnvFeature.WATER),
            ...
            new WordCore("karczm", WordCategory.STRUCTURE, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("karczm"), List.of(AdjectiveForms.createNy("karczem")), "Karczmiska;Zakarczmie;Karczmianka;Karczmarka;Karczmówka").places(Landmark.TAVERN),
            ...
            new WordCore("staroś", WordCategory.QUALITY, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createCi("staroś"), List.of(AdjectiveForms.createRy("sta")), "Starość;Starzyzna;Starówka;Starowinki"),
            ...
            new WordCore("wysokoś", WordCategory.QUALITY, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createCi("wysokoś"), List.of(AdjectiveForms.createKi("wyso"), AdjectiveForms.createOwy("wysokości")), "Wysokość;Wysokie").requires(EnvFeature.MOUNTAINS),
            ...
            new WordCore("płycizn", WordCategory.TERRAIN, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("płycizn"), List.of(AdjectiveForms.createKi("płyt")), "Płycizna;Płytka").requires(EnvFeature.WATER),
            ...
            new WordCore("dup", WordCategory.VULGAR, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("dup"), List.of(AdjectiveForms.createYI("dupn"), AdjectiveForms.createYI("dupczan"), AdjectiveForms.createSty("dupia")), "Zadupie;Dupice;Dupianka;Dupczyki;Dupownik;Dupownica;Dupice"),
            new WordCore("kurw", WordCategory.VULGAR, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("kurw"), List.of(AdjectiveForms.createI("kurw"), AdjectiveForms.createYI("kurwiczn"), AdjectiveForms.createSty("wykurwi"), AdjectiveForms.createOny("skurwi")), "Zakurwie;Kurwice;Kurwianka;Kurwiki"),
//            new WordCore("wod", WordCategory.TERRAIN, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("wod"), List.of(AdjectiveForms.createY("wodn")), ""),
            ...
            new WordCore("ziele", WordCategory.PLANT, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, new NounForms("zieleń", null), List.of(AdjectiveForms.createYI("zielon")), "Zielonki;Zielenica;Zieleniów;Zieleniówek;Zielenina"),
            new WordCore("suchoś", WordCategory.QUALITY, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, new NounForms("suchość", null), List.of(AdjectiveForms.createChy("su")), "Susza;Suchoty;Suchotnica;Suszanka;Sucharki;Sucharek"),
            ...
            new WordCore("susz", WordCategory.QUALITY, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, new NounForms("susza", null), List.of(AdjectiveForms.createOny("przesusz")), "Przesuszanka"),
            ...
            new WordCore("paster", WordCategory.PROFESSION, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAi ("pasterk"), List.of(AdjectiveForms.createKi("pasters")), "Pasterstwo;Pasternak"),
            ...
            //MASCULINE NON MASC
            new WordCore("smo", WordCategory.BEING, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createK("smo"), List.of(AdjectiveForms.createCzy("smo")), "Smoczanka;Smoczyce;Smokownica;Smoczówka;Smokowice;Smokownica"),
            ...
            new WordCore("korze", WordCategory.PLANT, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createNie("korze"), List.of(AdjectiveForms.createNy("korzen"), AdjectiveForms.createOwy("korzeni")), "Korzeniów;Korzeniówka;Korzenna;Korzenianka"),
            new WordCore("poto", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createK("poto"), List.of(AdjectiveForms.createCzny("poto"), AdjectiveForms.createOwy("potok")), "Potok;Potoczek;Potoczno;Potoczyca").requires(EnvFeature.WATER),
            new WordCore("lis", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("lis"), List.of(AdjectiveForms.createI("lis")), "Lisów;Lisowo;Liski;Lisianka;Lisowianka;Zalisie"),
            new WordCore("niedźwied", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createZZie("niedźwied"), List.of(AdjectiveForms.createI("niedźwiedz")), "Niedźwiedź;Niedźwiedna;Niedźwiedziów;Niedźwiedzianka"),
            new WordCore("mi", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createSie("mi"), List.of(AdjectiveForms.createOwy("misi")), "Miś;Misiowo;Misiów;Misianka;Misica"),
            new WordCore("jele", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createNie("jele"), List.of(AdjectiveForms.createI("jelen")), "Jeleń;Jelenie;Jeleniów;Jelenina"),
            new WordCore("dzik", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyI("dzik"), List.of(AdjectiveForms.createCzy("dzi")), "Dzików;Dzikowo;Dzikowiec;Dzikowice;Dziczyzna;Dzikówek"),
            new WordCore("zając", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyE("zając"), List.of(AdjectiveForms.createYY("zajęcz")), "Zajączki;Zajączków;Zajączkowo;Zającówka;Zającze;Zajęcze"),
            new WordCore("bóbr", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, new NounForms("bóbr",   "bobry"), List.of(AdjectiveForms.createYY("bobrz"), AdjectiveForms.createOwy("bobr")), "Bobrowniki;Bobrownica;Bobrowo;Bobrzanka;Bobrzanica;Bobrówka").requires(EnvFeature.WATER),
            new WordCore("bober", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("bober"), List.of(AdjectiveForms.createOwy("bober")), "Boberek;Boberowo;Bobernica").requires(EnvFeature.WATER),
            new WordCore("ko", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createNie("ko"), List.of(AdjectiveForms.createNski("ko")), "Końskie;Koniuszki;Konina;Konnica;Konianka;Koniówka"),
            new WordCore("ko", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("kot"), List.of(AdjectiveForms.createCi("ko")), "Kotów;Kocie;Kotki;Kocina;Kocizna;Kotówka;Kocica"),
            new WordCore("kogu", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("kogut"), List.of(AdjectiveForms.createCi("kogu")), "Kogutów;Kogutowo;Kogucizna;Kogutówka"),
            new WordCore("sam", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, new NounForms("samiec", "samce"), List.of(AdjectiveForms.createCzy("sam")), "Samców"),
            new WordCore("elf", WordCategory.BEING, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("elf"), List.of(AdjectiveForms.createI("elf"), AdjectiveForms.createKi("elfic")), ""),
            new WordCore("krasnolud", WordCategory.BEING, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("krasnolud"), List.of(AdjectiveForms.createKiCy("krasnoludz")), ""),
            new WordCore("dąb", WordCategory.PLANT, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, new NounForms("dąb", "dęby"), List.of(AdjectiveForms.createOwy("dęb")), "Dąbrowa;Dąbie;Dębina;Dębno;Dębica;Dębówka"),
            new WordCore("młyn", WordCategory.STRUCTURE, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("młyn"), List.of(AdjectiveForms.createKi("młyńs")), "Młyny;Zamłynie;Młynary;Młynów;Młyńsko;Młynno").places(Landmark.MILL),
            new WordCore("dwór", WordCategory.STRUCTURE, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, new NounForms("dwór", "dwory"), List.of(AdjectiveForms.createKi("dwors")), "Zadworze;Dwory;Poddworze;Podwórze;Dworki").places(Landmark.MANOR),
            ...
            new WordCore("kamie", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createNie("kamie"), List.of(AdjectiveForms.createNy("kamien")), "Kamień;Kamienica;Podkamień;Kamienno;Kamieniówek;Kamienisko;Kamieniów"),
            new WordCore("głaz", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("głaz"), List.of(AdjectiveForms.createOwy("głaz")), "Głazowisko;Głazówka;Głazówek;Głaźnica;Głazownica;Zagłazie;Głazanki"),
            new WordCore("pias", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEk("pias"), List.of(AdjectiveForms.createOwy("piask"), AdjectiveForms.createSty("piaszczy")), "Piaski;Piaseczno;Piasków;Piaskownica;Piaszczanka;Piaskówka;Piaskowo").requires(EnvFeature.SAND),
            new WordCore("dół", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, new NounForms("dół", "doły"), List.of(AdjectiveForms.createNy("dol")), "Zadole;Podole;Nadole;Doły;Dolnica;Dołków;Dołek"),
            new WordCore("niż", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyE("niż"), List.of(AdjectiveForms.createKi("nis"), AdjectiveForms.createOwy("niż")), "Niżówek;Niżanka;Niżówka"),
            new WordCore("wiatr", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("wiatr"), List.of(AdjectiveForms.createYI("wietrzn"), AdjectiveForms.createOwy("wiatr")), "Wiatrowo;Wietrzno;Wietrznica;Wiatrów;Wywietrznik;Wietrzniki"),
            new WordCore("wich", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyEr("wich"), List.of(AdjectiveForms.createOwy("wichr")), "Wichrowo;Wichrów;Wichranka;Wichrzyca"),
            new WordCore("gwizd", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("gwizd"), List.of(AdjectiveForms.createCy("gwiżdzą")), "Gwizdek;Gwizdawka;Gwizdówek;Wygwizdów;Przegwizdów"),
            new WordCore("mrok", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyI("mrok"), List.of(AdjectiveForms.createYI("mroczn")), "Mroczków;Mroki;Mroczyska;Mroczica;Zamrocze;Mrocze;Mrocznówek;Mroczanka"),
            new WordCore("cie", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createNie("cie"), List.of(AdjectiveForms.createSty("cieni")), "Cienie;Cieniówek;Cienica;Cienianka"),
            new WordCore("osi", WordCategory.ANIMAL, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, new NounForms("osioł", "osły"), List.of(AdjectiveForms.createIorA("ośl")), "Osłów;Oślica;Osioł;Oślanka;Osłówek;Osłówka"),
            new WordCore("płomie", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createNie("płomie"), List.of(AdjectiveForms.createYI("płomienn")), "Płonień;Płomienno;Płomieniówek;Płomienica"),
            new WordCore("wzgór", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEk("wzgór"), List.of(AdjectiveForms.createOwy("wzgórk")), "Wzgórek;Wzgórno"),
            //MASCULINE MASC
//            new WordCore("dra", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.MASC_PERSONAL, NounForms.createNie("dra"), List.of(AdjectiveForms.createNski("dra"), AdjectiveForms.createNny("dra")), ""),
            new WordCore("kupi", WordCategory.PROFESSION, WordGender.MASCULINE, PluralType.MASC_PERSONAL, NounForms.createIec("kup"), List.of(AdjectiveForms.createNski("dra"), AdjectiveForms.createEcki("kupi")), "Przekupka;Kupianka;Zakupka;Zakupek;Zakupków;Zakupice;Kupczyk"),
            ...
            new WordCore("rybak", WordCategory.PROFESSION, WordGender.MASCULINE, PluralType.MASC_PERSONAL, NounForms.createKCy ("ryba"), List.of(AdjectiveForms.createKi("rybac")), "Rybaki;Rybaków;Rybitwa").requires(EnvFeature.WATER),
            new WordCore("myśliw", WordCategory.PROFESSION, WordGender.MASCULINE, PluralType.MASC_PERSONAL, NounForms.createYi ("myśliw"), List.of(AdjectiveForms.createKi("myśliws")), "Myśliwka;Myśliwiec"),
            ...
            new WordCore("kowal", WordCategory.PROFESSION, WordGender.MASCULINE, PluralType.MASC_PERSONAL, NounForms.createEmptyE ("kowal"), List.of(AdjectiveForms.createKi("kowals")), "Kowale;Kowalewo;Kowalsko;Kowalówek;Kowalnica"),
            new WordCore("młyna", WordCategory.PROFESSION, WordGender.MASCULINE, PluralType.MASC_PERSONAL, NounForms.createEmptyE ("młynarz"), List.of(AdjectiveForms.createKi("młynars")), "Młynarka;Młynówka;Młyniarka;Młynianka;Młynowice"),
            new WordCore("wędrow", WordCategory.PROFESSION, WordGender.MASCULINE, PluralType.MASC_PERSONAL, new NounForms("wędrowiec", "wędrowcy"), List.of(AdjectiveForms.createNy("wędrow")), "Wędrowice;Wędrowo;Wędrówkowo;Wędrowianka;Wędrówka"),

            //NON ADJECTIVE
            new WordCore("uroczysk", WordCategory.STRUCTURE, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createO("uroczysk"), List.of(), "Uroczysko;Uroczyska"),
            new WordCore("trakt", WordCategory.STRUCTURE, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("trakt"), List.of(), "Traktówka;Traktacik"),
            ...
            new WordCore("siedliszcz", WordCategory.STRUCTURE, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createE("siedliszcz"), List.of(), "Siedliszcze;Siedliszcza"),
            new WordCore("wież", WordCategory.STRUCTURE, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAe("wież"), List.of(), "Wieżówka;Wieżanka").places(Landmark.TOWER),
            new WordCore("wieżyc", WordCategory.STRUCTURE, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAe("wieżyc"), List.of(), "Wieżyca").places(Landmark.TOWER),
            new WordCore("most", WordCategory.STRUCTURE, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("most"), List.of(), "Mosty;Zamoście;Mościska;Mostówka;Podmoście;Przymoście;Nadmoście;Mostówek").requires(EnvFeature.WATER).places(Landmark.BRIDGE),
            new WordCore("chat", WordCategory.STRUCTURE, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, NounForms.createAy("chat"), List.of(), "Chatówka"),
            new WordCore("doł", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEk("doł"), List.of(), "Dołek;Dołki;Dołczan;Dołczanki;Dołczany"),
            //NON PLURAL, NON ADJECTIVE
            new WordCore("wieś", WordCategory.STRUCTURE, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, new NounForms("wieś", null), List.of(), "Wiocha"),
            new WordCore("wola", WordCategory.STRUCTURE, WordGender.FEMININE, PluralType.NON_MASC_PERSONAL, new NounForms("wola", null), List.of(), "Wola;Wolica"),
            ...
            new WordCore("bór", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, new NounForms("bór", "bory"), List.of(AdjectiveForms.createOwy("bor")), "Bór;Borek;Borowo;Borowina;Borczany;Borówka;Borowica").requires(EnvFeature.FOREST),
            new WordCore("gaj", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyE("gaj"), List.of(AdjectiveForms.createOwy("gaj")), "Gaj;Gaje;Gajów;Gajówka;Zagaje;Gajanka;Zagajnik;Podgaje").places(Landmark.GROVE),
            new WordCore("staw", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createEmptyY("staw"), List.of(AdjectiveForms.createOwy("staw")), "Stawy;Zastawie;Podstawie;Stawiszcze;Stawianka;Stawiany").requires(EnvFeature.WATER),
            new WordCore("jezior", WordCategory.TERRAIN, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createO("jezior"), List.of(AdjectiveForms.createNy("jezior"), AdjectiveForms.createOwy("jezior")), "Jeziorko;Jeziorany;Zajezierze;Jeziorna;Jeziorówka;Jeziorniki").requires(EnvFeature.WATER),
            new WordCore("strumie", WordCategory.TERRAIN, WordGender.MASCULINE, PluralType.NON_MASC_PERSONAL, NounForms.createNie("strumie"), List.of(AdjectiveForms.createNy("strumien")), "Strumień;Strumiany;Strumienno;Strumieniówek;Strumiennik").requires(EnvFeature.WATER),
            new WordCore("bagn", WordCategory.TERRAIN, WordGender.NEUTRAL, PluralType.NON_MASC_PERSONAL, NounForms.createO("bagn"), List.of(AdjectiveForms.createNy("bagien"), AdjectiveForms.createSty("bagni")), "Bagno;Bagienko;Zabagnie;Bagniszcze;Bagnisko;Bagiennik").requires(EnvFeature.WETLAND),
            //TODO stąd w dół jeszcze porobić jednosłowówki
